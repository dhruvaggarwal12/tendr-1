  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8F4EF", fontFamily: font }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 20px 80px" }}>
        ...
        {/* How to book strip */}
        {showHowToBook && (
          <div style={{ background: "linear-gradient(135deg,#2C1A0E,#4A2810)", borderRadius: 12, padding: "10px 14px", marginBottom: 16, fontFamily: font, boxShadow: "0 4px 16px rgba(44,26,14,0.18)" }}>
        ...
        {showTip && (
          <div style={{ position: "fixed", bottom: "calc(72px + env(safe-area-inset-bottom,0px))", left: "50%", transform: "translateX(-50%)", zIndex: 100010, background: "#FFFCF5", borderRadius: 14, padding: "14px 18px", boxShadow: "0 8px 32px rgba(44,26,14,0.2)", border: "1.5px solid rgba(196,122,46,0.25)", fontFamily: font, maxWidth: 320, width: "90%" }}>
