...
function GigProProfile({ d, tab, setTab, showBook, setShowBook }) {
  ...
  return (
    <>
      ...
      <div style={{ background: parch, borderBottom: "1px solid rgba(196,122,46,0.1)" }}>
        ...
        <div className="gp-hero-grid" style={{ maxWidth: 1100, margin: "0 auto", padding: "36px 28px 40px", display: "grid", gridTemplateColumns: "260px 1fr 210px", gap: 32, alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            {/* Mobile CTAs — full-width Book Now + Chat/Call/Share row */}
            <div className="gp-mobile-ctas" style={{ display: "none", flexDirection: "column", gap: 10 }}>
              <button onClick={() => setShowBook(true)} style={{ width: "100%", padding: "15px", borderRadius: 100, background: `linear-gradient(135deg,${gold},${goldLt})`, color: "#fff", fontSize: 15, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: font, boxShadow: `0 6px 20px rgba(196,122,46,0.38)` }}>
                Book Now
              </button>
      ...
      {/* ── Content + Sidebar ── */}
      <div style={{ background: cream }}>
        <div className="gp-content-grid" style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 24px 48px", display: "grid", gridTemplateColumns: "1fr 280px", gap: 24, alignItems: "start" }}>
