...
const STATUS_INFO = {
  ...
  form_sent: {
    icon: "📋",
    title: "Form Sent",
    message: "Our team has sent you a Google Form on WhatsApp. Please fill it out to proceed with your registration.",
    color: "#0369a1", bg: "#eff6ff", border: "#bfdbfe",
  },
  approved: {
    icon: "✅",
    title: "Application Approved!",
    message: "Congratulations! You have been approved by Tendr. Our team will contact you on WhatsApp to complete your onboarding.",
    color: "#15803d", bg: "#f0fdf4", border: "#bbf7d0",
  },
  registered: {
    icon: "🎉",
    title: "You're a Tendr Vendor!",
    message: "Welcome to Tendr! You are now fully registered. Check your WhatsApp for your vendor profile details and next steps.",
    color: "#15803d", bg: "#f0fdf4", border: "#bbf7d0",
  },
  rejected: {
    icon: "❌",
