...
const OCCASIONS = {
  ...
  anniversary: {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Fun for everyone", tools: [
        ...
        { id: "couplesync",      emoji: "💞", title: "Couple Sync",            desc: "Answer separately · reveal simultaneously",     color: "#F472B6" },
  ...
  "baby-shower": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Playful predictions", tools: [
        { id: "babypredmarket",  emoji: "📊", title: "Baby Prediction Market", desc: "1,000 coins · bet on weight · date · hair",      color: "#38BDF8" },
  ...
  housewarming: {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Get comfortable together", tools: [
        ...
        { id: "househunt",    emoji: "🔍", title: "House Hunt",       desc: "Find hidden items around the new home",         color: "#A78BFA" },
  ...
  "kitty-party": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Ladies night fun", tools: [
        ...
        { id: "kittybattle",    emoji: "⚔️", title: "Kitty Battle",       desc: "Team games · points · trophy at end",           color: "#EF4444" },
  ...
  "first-birthday": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Fun", subtitle: "Games for the little one's day", tools: [
        ...
        { id: "babysays",      emoji: "🍼", title: "Baby Says...",            desc: "Predict what baby does next · host reveals",   color: "#F472B6" },
  ...
  "newborn-welcome": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Celebrate the new arrival", tools: [
        ...
        { id: "blessingtree",    emoji: "🌳", title: "Digital Blessing Tree",  desc: "Every guest adds a leaf · the tree grows",      color: "#34D399" },
  ...
  "gender-reveal": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Fun before the big reveal", tools: [
        ...
        { id: "predictionlock",  emoji: "🔒", title: "Prediction Lock",       desc: "Everyone locks their guess · reveal after",     color: "#F472B6" },
  ...
  graduation: {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Celebrate in style", tools: [
        ...
        { id: "wherewillthey",  emoji: "🔮", title: "Where Will They Be?",  desc: "Predict classmates in 5 years · vote & reveal", color: "#8B5CF6" },
  ...
  wedding: {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Keep the energy going", tools: [
        ...
        { id: "couplestoryquest", emoji: "📖", title: "Couple Story Quest",     desc: "Guests unlock story chapters by answering right", color: "#F472B6" },
  ...
  farewell: {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "One last game together", tools: [
        ...
        { id: "memorywallguess",emoji: "🖼️", title: "Memory Wall Guess",  desc: "Whose photo is this? When was it taken?",   color: "#8B5CF6" },
  ...
  retirement: {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Fun", subtitle: "Lighthearted celebration", tools: [
        ...
        { id: "careertlchallenge",emoji: "⏳", title: "Career Timeline Challenge",desc: "Arrange their career milestones in order",  color: "#F59E0B" },
  ...
  "diwali-party": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "The Diwali classics", tools: [
        ...
        { id: "diwalibazaar", emoji: "🏪", title: "Diwali Bazaar",         desc: "Virtual stalls · bid with diyas coins",    color: "#F59E0B" },
        { id: "diwalitreasure",emoji: "🗺️", title: "Diwali Treasure Hunt", desc: "Clues around the venue · festive theme",  color: "#EF4444" },
  ...
  "holi-party": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "After the gulal settles", tools: [
        ...
        { id: "colourwars",   emoji: "🎨", title: "Colour Wars",        desc: "Team Red vs Team Blue vs Team Yellow · score",color: "#EF4444" },
        { id: "holimissions", emoji: "🎯", title: "Holi Missions",      desc: "Secret tasks · complete without getting caught",color: "#8B5CF6" },
  ...
  "navratri-garba": {
    ...
    sections: [
      ...
      { id: "games", label: "🎮 Games", subtitle: "Between the garba rounds", tools: [
        ...
        { id: "garbabattle", emoji: "⚔️", title: "Garba Battle",        desc: "Group vs group · judges score · final winner",  color: "#EF4444" },
  ...
  "naming-ceremony": {
    ...
    sections: [
      ...
      { id: "ceremony", label: "✨ Ceremony", subtitle: "Meaningful moments", tools: [
        ...
        { id: "namelab",       emoji: "🔬", title: "Name Lab",               desc: "Break the name into meaning · origin · vibe", color: "#A78BFA" },
        { id: "namedetective", emoji: "🕵️", title: "Name Detective",         desc: "Clues lead to a name · guests guess it",      color: "#38BDF8" },
        { id: "namebattle",    emoji: "⚔️", title: "Name Battle",            desc: "Bracket tournament · guests vote each round",  color: "#EF4444" },
        { id: "familynametree",emoji: "🌳", title: "Family Name Tree",       desc: "Map names across generations · spot patterns", color: "#10B981" },
        { id: "blessinggen",   emoji: "✨", title: "Blessing Generator",     desc: "AI-style blessing using baby's name letters",  color: "#F59E0B" },
      ]},
