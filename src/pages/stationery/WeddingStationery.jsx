...
export default function WeddingStationery() {
  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: font, backgroundImage: "linear-gradient(rgba(250,245,238,0.88),rgba(250,245,238,0.88)), url('https://images.unsplash.com/photo-1507692049790-de58290a4334?w=1600&auto=format&q=65')", backgroundSize: "cover", backgroundPosition: "center" }}>
