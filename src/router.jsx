...
const VendorDashboard     = lazy(() => import("./pages/vendor/VendorDashboardNew"));
...
const ServiceDemoDashboard  = lazy(() => import("./pages/vendor/ServiceDemoDashboard"));
...
// Auth
  ...
  { path: '/newborn-welcome-hub', element: <OccasionHub occasion="newborn-welcome" />, errorElement: <ErrorPage /> },
  { path: '/gender-reveal-hub', element: <OccasionHub occasion="gender-reveal" />, errorElement: <ErrorPage /> },
  ...
  { path: '/graduation-hub', element: <OccasionHub occasion="graduation" />, errorElement: <ErrorPage /> },
  { path: '/wedding-hub', element: <OccasionHub occasion="wedding" />, errorElement: <ErrorPage /> },
  { path: '/bachelorette-hub', element: <OccasionHub occasion="bachelorette" />, errorElement: <ErrorPage /> },
  { path: '/farewell-hub', element: <OccasionHub occasion="farewell" />, errorElement: <ErrorPage /> },
  { path: '/retirement-hub', element: <OccasionHub occasion="retirement" />, errorElement: <ErrorPage /> },
  { path: '/diwali-party-hub', element: <OccasionHub occasion="diwali-party" />, errorElement: <ErrorPage /> },
  { path: '/holi-party-hub', element: <OccasionHub occasion="holi-party" />, errorElement: <ErrorPage /> },
  { path: '/navratri-garba-hub', element: <OccasionHub occasion="navratri-garba" />, errorElement: <ErrorPage /> },
