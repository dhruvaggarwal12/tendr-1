    ...
    <>
      ...
      <div style={{ background: cream }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "20px 24px 0" }}>
          <div style={{ background: "#fff", borderRadius: 16, display: "flex", border: "1px solid rgba(196,122,46,0.1)", overflow: "hidden", boxShadow: "0 2px 12px rgba(28,10,4,0.05)" }}>
            {[
      ...
      {/* ── Content + Sidebar ── */}
      <div style={{ background: cream }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 24px 48px", display: "grid", gridTemplateColumns: "1fr 280px", gap: 24, alignItems: "start" }}>
