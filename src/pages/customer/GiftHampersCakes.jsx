  ...
  const goToChat = async () => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/conversations/baat-karo`, {
        ...
        body: JSON.stringify({ message: msg, serviceType: "My Order", bookingCategory: "gift-hampers" }),
      });
      ...
      if (res.ok && data.conversationId) {
        ...
        openExistingChat(cid, { _id: null, name: "Tendr Team", serviceType: "My Order", approved: true });
      }
